 ...
 */
 export const createFullName = (firstName, lastName) => {
  ...
  export const celsiusToFahrenheit = (tempInCelsius) => {
    tempInFarh = (tempInCelsius * 1.8) + 32;
    return (`${tempInCelsius} degrees celsius is ${tempInFarh} degrees fahrenheit`);
  };
  ...
  export const calculateLifetimeSupply = (snickersPerDay, age, maxAge) => {
    var numDaysLeft = (maxAge-age)*365;
    return snickersPerDay*numDaysLeft;
  };
  ...
  export const getStudentSummary = (score, name) => {
    ...
    switch(grade) {
      case "A":
        return (`Congratulations ${name}! Yu achieved a grade of A.`);
      case "B":
