...
export class Coordinate {
  ...
  export class Counter {
     ...
     */
    constructor(count) {
        count === undefined ? this.count = 0 : this.count = count;
    }
    ...
    decrement() {
        return this.count === 0 ? Number(this.count = 0) : Number(this.count--);
    }
  }
  ...
  export class BankAccount {
    ...
    constructor(name, email, balance) {
        this.name = name;
        this.email = email;
        balance === undefined ? this._balance = 0 : this._balance = balance;
    }
    ...
    withdraw(amount) {
        ...
        else if (Number(amount) > this._balance) {
            return "Insufficient funds, unable to withdraw";
        }
        this._balance = this._balance - Number(amount);
        return this._balance;
    }
  }
